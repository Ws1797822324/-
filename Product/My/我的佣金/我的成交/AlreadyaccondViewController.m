...
@interface AlreadyaccondViewController ()<UITableViewDelegate,UITableViewDataSource>{
    NSString *type;
}
...
@implementation AlreadyaccondViewController
...
- (void)loadRequest
{
    self.page = @"0";
    kUserData;
    NSDictionary * dic = [[NSDictionary alloc] initWithObjectsAndKeys:@"selmyCommission",@"opt",@"2",@"type",userInfo.token,@"token",@"1",@"tag",self.page,@"page",self.rows,@"row", nil];
