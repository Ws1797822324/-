//
//  NewStayaccountsViewController.m
//  Product
//
...
@interface NewStayaccountsViewController ()<UITableViewDelegate,UITableViewDataSource>{
    NSString *type;
}
...
@implementation NewStayaccountsViewController
...
- (void)loadRequest
{
    ...
    NSDictionary * dic = [[NSDictionary alloc] initWithObjectsAndKeys:@"selmyCommission",@"opt",@"1",@"type",userInfo.token,@"token",@"2",@"tag",self.page,@"page",self.rows,@"row", nil];
...
-(void)setUI{
    ...
    [self.tableview registerNib:[My_YongJin_Cell nib] forCellReuseIdentifier:@"My_Default_Cell_ID"];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    My_YongJin_Cell *cell = [tableView dequeueReusableCellWithIdentifier:@"My_Default_Cell_ID"];
    cell.time_L.hidden = YES;
