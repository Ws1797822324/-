...
#pragma mark - 计算时间差
+(NSString *) timeStampIntoimeDifference:(NSString *)timeStampStr
 {
     NSArray * arr = [timeStampStr componentsSeparatedByString:@"."];
     timeStampStr = [arr firstObject];
    
    NSDateFormatter *dateFormatter = [[NSDateFormatter alloc]init];
    [dateFormatter setDateFormat:@"yyyy-MM-dd HH:mm:ss"];
    NSDate *timeDate = [dateFormatter dateFromString:timeStampStr];
    //八小时时区
