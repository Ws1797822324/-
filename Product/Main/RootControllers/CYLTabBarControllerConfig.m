...
- (NSArray *)viewControllers {
    ...
    UIViewController *firstNavigationController = [[YMNavgatinController alloc]
                                                   initWithRootViewController:firstViewController];
    
    Client_VC *secondViewController = [Client_VC viewControllerFromNib];


    
    UIViewController *secondNavigationController = [[MainNavViewController alloc]
                                                    initWithRootViewController:secondViewController];

    kUserData;

    if ([userInfo.status intValue] == 1) {   // 判断是否是经纪人
        ApplyViewController * vc = [ApplyViewController viewControllerFromNib];
        secondNavigationController = [[MainNavViewController alloc]
    ...
    Contact_VC *ContactsV = [[Contact_VC alloc]init];
    UIViewController *thirdNavigationController = [[MainNavViewController alloc]
                                                   initWithRootViewController:ContactsV];



//    thirdNavigationController.tabBarItem.badgeValue = @"100";

    MyViewController *fourthViewController = [[MyViewController alloc] init];
    UIViewController *fourthNavigationController = [[YMNavgatinController alloc]
...
//     tabBarController.tabBarHeight = CYLTabBarControllerHeight;
    ...
    selectedAttrs[NSForegroundColorAttributeName] = kRGB_HEX(0x4f9bfc);
